...
if (isset($_POST['action']) && $_POST['action'] == 'add_to_cart') {
    ...
    $usuarioId = $_POST['user_id']; // Asegúrate de que el ID del usuario se obtenga de alguna manera segura, por ejemplo, desde la sesión
...
if (isset($_GET['action']) && $_GET['action'] == 'get_cart') {
    $usuarioId = $_GET['user_id']; // Asegúrate de que el ID del usuario se obtenga de manera segura, por ejemplo, desde la sesión
